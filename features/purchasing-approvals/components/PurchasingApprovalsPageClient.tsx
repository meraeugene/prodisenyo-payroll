...
const INITIAL_POS: PurchaseOrder[] = [
  {
    ...
    items: [
      {
        name: "Structural Reinforcement Steel Rebar 25mm",
        qty: 500,
        unitPrice: 1800,
      },
      {
        name: "Structural Reinforcement Steel Rebar 20mm",
        qty: 250,
        unitPrice: 1400,
      },
    ],
  ...
  },
  {
    ...
    items: [
      {
        name: "Ready-Mix Concrete 4000 PSI Class A",
        qty: 120,
        unitPrice: 5166.67,
      },
    ],
  ...
  },
  {
    ...
    items: [
      {
        name: "High-Voltage Distribution Copper Cable 150m",
        qty: 3,
        unitPrice: 150000,
      },
    ],
...
export default function PurchasingApprovalsPageClient() {
  ...
  const handleConfirm = () => {
    ...
    startTransition(async () => {
      ...
      toast.success(
        `Purchase Order ${reviewingPO.poNumber} successfully ${statusWord}!`,
      );
      setReviewingPO(null);
    });
  };
        ...
        {filteredPOs.length > 0 ? (
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-50 pb-3">
                <div className="flex items-center gap-3">
                    ...
                    <img
                      src={
                        po.vendorName.toLowerCase().includes("steel")
                          ...
                          : po.vendorName.toLowerCase().includes("concrete") ||
                              po.vendorName.toLowerCase().includes("rock")
                            ? "https://images.unsplash.com/photo-1589939705384-5185137a7f0f?auto=format&fit=crop&w=150&q=80"
                            : po.vendorName
                                  .toLowerCase()
                                  .includes("electrical") ||
                                po.vendorName.toLowerCase().includes("power")
                  ...
                  <div className="space-y-0.5">
                    ...
                    <h4 className="font-extrabold text-slate-700 text-sm mt-1">
                      {po.vendorName}
                    </h4>
                  </div>
                </div>
                ...
                <div className="border-l border-slate-100 pl-6 flex flex-col justify-between">
                  <div className="space-y-2">
                    <div className="space-y-0.5">
                      ...
                      <p className="text-xs font-bold text-apple-charcoal">
                        {po.projectName}
                      </p>
                    </div>
                    <div className="space-y-0.5">
          ...
          <div className="text-center py-16 bg-white border border-dashed border-slate-200 rounded-2xl">
            ...
            <p className="text-xs text-slate-400 mt-1">
              Check back later for new procurement requests.
            </p>
          </div>
        )}
      </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/50 backdrop-blur-xs animate-in fade-in duration-200">
          <div className="w-full max-w-md bg-white border border-apple-mist rounded-2xl p-6 shadow-2xl animate-in zoom-in-95 duration-200">
            ...
            <p className="text-xs text-slate-500 mt-1">
              {reviewingPO.poNumber} for {reviewingPO.vendorName} (
              {formatCurrency(reviewingPO.amount)})
            </p>
